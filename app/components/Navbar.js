...
export default function Navbar() {
  ...
  return (
    <nav className="fixed left-0 top-0 h-screen w-28 flex flex-col items-center justify-between py-8 z-50" style={{ background: 'var(--background)', borderRight: '1px solid rgba(255,255,255,0.04)' }}>
      {/* Logo at top */}
